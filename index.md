...
<script>
  ...
  function kategoriSec(kategori) {
    ...
    document.getElementEvet, **canvas'a (veya dosyana) sadece HTML ve CSS gelmiş, ama Adam Asmaca oyununun JavaScript kısmı eksik**.  
Senin Adam Asmaca oyununun tüm çalışan JavaScript kodunu ekleyerek **tam ve çalışan halini** buraya bırakıyorum.  
Bunu **direkt olarak canvas'taki kodun altına** veya `<script>...</script>` arasına ekle!

---

Aşağıdaki kodu **tüm script kısmına** ekle, her şey çalışacak:
